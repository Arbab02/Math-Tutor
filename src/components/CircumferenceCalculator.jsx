...
const CircumferenceCalculator = () => {
  ...
  const calculateCircumference = () => {
    ...
    if (!isNaN(parsedRadius)) {
      const calculatedCircumference = 2 * Math.PI * parsedRadius;
      setCircumference(calculatedCircumference.toFixed(2));
    } else {
      setCircumference('Invalid input');
    }
  };
  ...
  return (
    ...
    <div className="bg-black max-w-md mx-auto mt-10 p-4 border-solid border-gray-800 border-8  rounded shadow-lg">
      ...
      <h1 className="text-white text-center text-2xl font-bold mb-4">Circumference Calculator</h1>
        <div className="mb-4">
        ...
        <div className="mb-4">
          <label htmlFor="circumference" className="text-white mr-2">
            Circumference:
          </label>
          <input
            type="text"
